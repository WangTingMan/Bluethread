...
private:
     ...
     */
    uint16_t handle_config_request
        (
        uint8_t const* a_raw_sig,
        uint16_t a_size
        );
     ...
     */
    uint16_t handle_config_response
        (
        uint8_t const* a_raw_sig,
        uint16_t a_size
        );
    ...
    uint16_t handle_credit_based_reconfig_request
        (
        uint8_t const* a_raw_sig,
        uint16_t a_size
        );

    uint16_t handle_credit_based_reconfig_response
        (
        uint8_t const* a_raw_sig,
        uint16_t a_size
        );
